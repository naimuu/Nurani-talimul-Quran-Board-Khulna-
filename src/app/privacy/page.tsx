...
export const metadata = {
  title: "গোপনীয়তা নীতি | নূরানী বোর্ড খুলনা",
      ...
      <div className="w-full max-w-[1720px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-10">
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-sm space-y-6">
          ...
          <div className="space-y-4 text-slate-700 text-sm sm:text-base leading-relaxed">
            ...
            <p>
              নূরানী বোর্ড খুলনা মাদরাসা নিবন্ধন, ছাত্র-ছাত্রীদের কেন্দ্রীয় পরীক্ষা, শিক্ষক প্রশিক্ষণ ও সনদ প্রদানের প্রয়োজনে প্রয়োজনীয় তথ্য (যেমন: মাদরাসার নাম, ঠিকানা, দায়িত্বশীলদের ফোন নম্বর, শিক্ষার্থীদের রোল/রেজিস্ট্রেশন নম্বর) সংগ্রহ ও সংরক্ষণ করে।
            </p>
