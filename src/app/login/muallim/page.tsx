...
export default function MuallimLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      window.location.href = data.redirectUrl || "/muallim";
    } catch { 
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-slate-800 mb-2 tracking-tight">মুয়াল্লিম লগইন</h1>
          <p className="text-slate-500 text-sm">আপনার ড্যাশবোর্ডে প্রবেশ করতে লগইন করুন</p>
        </div>
        ...
        <div className="mb-6">
          ...
          <select
            ...
            onChange={(e) => {
              if (e.target.value !== "/login/muallim") {
                router.push(e.target.value);
              }
            }}
            defaultValue="/login/muallim"
          >
