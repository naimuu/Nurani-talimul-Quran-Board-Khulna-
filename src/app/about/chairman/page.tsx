        ...
        <div className="lg:col-span-8">
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 md:p-12 h-full">
            ...
            <div className="text-slate-700 leading-relaxed text-justify font-medium">
              ...
              <div className="mt-8 font-bold text-slate-800">
                <p>বিনীত -</p>
                <p className="mt-2 text-lg">আল্লামা খলিল আহমদ কাসেমী (দা: বা:)</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-slate-200 flex flex-col hover:border-primary/30 transition-colors">
            <div className="flex items-start justify-between gap-4 mb-4">
              <div className="flex-1">
                <h4 className="font-bold text-blue-900 text-lg leading-tight mb-1">মুফতি জসিম উদ্দীন সাহেব</h4>
                <span className="text-xs font-bold text-red-500">মহাসচিব</span>
              </div>
              <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-primary/20 flex-shrink-0 relative">
                <div className="absolute inset-0 bg-slate-200" />
                <Image 
                  src="https://images.unsplash.com/photo-1585036156171-384164a8c675?q=80&w=200&auto=format&fit=crop" 
                  alt="Secretary" 
                  fill 
            ...
            <Link href="/about/secretary" className="inline-block bg-blue-800 text-white text-xs font-bold px-6 py-2 rounded-full hover:bg-blue-900 transition-colors w-max mt-2">
              বিস্তারিত
            </Link>
          </div>
