    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button
                ...
                className="px-6 py-2.5 bg-red-600 text-white font-medium rounded-xl hover:bg-red-700 transition-colors inline-flex justify-center items-center"
              >
                পুনরায় চেষ্টা করুন
              </button>
            </div>
      ...
      >
        ...
        <div className="mb-6">
          ...
          <select
            className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500 cursor-pointer transition-all duration-200 font-medium"
            onChange={(e) => {
              if (e.target.value !== "/admin/login") {
                router.push(e.target.value);
              }
            }}
            defaultValue="/admin/login"
          >
            <option value="/admin/login">অ্যাডমিন লগইন</option>
